...
다음 기준을 적용해서 작성해:
1. 각 scene 마다 image_prompt 는 영어로 자세하게 작성해야 해: 쇼츠에 알맞는 이미지를 생성하기 위한 프롬프트를 작성해.
...
5. 도입 3초를 ‘질문’ or ‘충격적 사실’로 시작해.
6. 영상 길이는 30초 내외야.
7. scenes 는 총 6장면이 나와야 해.
8. hashtag 는 영상과 관련된 키워드로 5~7개 추천해줘.
